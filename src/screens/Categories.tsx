    ...
    return (
        <div className='d-flex'>
            ...
            <div className='container-fluid'>
                <TopBar topbarTitle="Catégories" />

                <div className="card shadow">
                    <div className="card-header d-flex justify-content-around my-4">
                        <div className="w-100 d-flex align-items-center">
                            <input type="text" className='form-control rounded w-50 p-2' placeholder='search' />
                        ...
                        <table className="table table-hover">
                            <thead>
                                <tr className='table-dark border-0'>
                                    ...
                                    <th className='bg-dark'>Désignation</th>
                                    <th className="bg-light" style={{ width: "1%" }}></th>
                                    <th className="bg-light" style={{ width: "1%" }}></th>
                                    <th className="bg-light" style={{ width: "1%" }}></th>
                                </tr>
                            </thead>
